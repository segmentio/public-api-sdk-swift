...
open class FunctionsAPI {
     ...
     */
    @discardableResult
    open class func createFunction(createFunctionV1Input: CreateFunctionV1Input, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CreateFunction200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createFunctionWithRequestBuilder(createFunctionV1Input: CreateFunctionV1Input) -> RequestBuilder<CreateFunction200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CreateFunction200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func createFunctionDeployment(functionId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CreateFunctionDeployment200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createFunctionDeploymentWithRequestBuilder(functionId: String) -> RequestBuilder<CreateFunctionDeployment200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CreateFunctionDeployment200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func deleteFunction(functionId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DeleteFunction200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func deleteFunctionWithRequestBuilder(functionId: String) -> RequestBuilder<DeleteFunction200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<DeleteFunction200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getFunction(functionId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetFunction200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getFunctionWithRequestBuilder(functionId: String) -> RequestBuilder<GetFunction200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetFunction200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listFunctions(pagination: PaginationInput, resourceType: ResourceType_listFunctions, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ListFunctions200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func listFunctionsWithRequestBuilder(pagination: PaginationInput, resourceType: ResourceType_listFunctions) -> RequestBuilder<ListFunctions200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListFunctions200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func updateFunction(functionId: String, updateFunctionV1Input: UpdateFunctionV1Input, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: UpdateFunction200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func updateFunctionWithRequestBuilder(functionId: String, updateFunctionV1Input: UpdateFunctionV1Input) -> RequestBuilder<UpdateFunction200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<UpdateFunction200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
