...
open class DeletionAndSuppressionAPI {
     ...
     */
    @discardableResult
    open class func createCloudSourceRegulation(sourceId: String, createCloudSourceRegulationV1Input: CreateCloudSourceRegulationV1Input, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CreateCloudSourceRegulation200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createCloudSourceRegulationWithRequestBuilder(sourceId: String, createCloudSourceRegulationV1Input: CreateCloudSourceRegulationV1Input) -> RequestBuilder<CreateCloudSourceRegulation200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CreateCloudSourceRegulation200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func createSourceRegulation(sourceId: String, createSourceRegulationV1Input: CreateSourceRegulationV1Input, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CreateSourceRegulation200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createSourceRegulationWithRequestBuilder(sourceId: String, createSourceRegulationV1Input: CreateSourceRegulationV1Input) -> RequestBuilder<CreateSourceRegulation200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CreateSourceRegulation200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func createWorkspaceRegulation(createWorkspaceRegulationV1Input: CreateWorkspaceRegulationV1Input, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CreateWorkspaceRegulation200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createWorkspaceRegulationWithRequestBuilder(createWorkspaceRegulationV1Input: CreateWorkspaceRegulationV1Input) -> RequestBuilder<CreateWorkspaceRegulation200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CreateWorkspaceRegulation200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func deleteRegulation(regulateId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DeleteRegulation200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func deleteRegulationWithRequestBuilder(regulateId: String) -> RequestBuilder<DeleteRegulation200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<DeleteRegulation200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getRegulation(regulateId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetRegulation200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getRegulationWithRequestBuilder(regulateId: String) -> RequestBuilder<GetRegulation200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetRegulation200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func listRegulationsFromSourceWithRequestBuilder(sourceId: String, pagination: PaginationInput, status: Status_listRegulationsFromSource? = nil, regulationTypes: [RegulationTypes_listRegulationsFromSource]? = nil) -> RequestBuilder<ListRegulationsFromSource200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListRegulationsFromSource200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listSuppressions(pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ListSuppressions200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func listSuppressionsWithRequestBuilder(pagination: PaginationInput) -> RequestBuilder<ListSuppressions200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListSuppressions200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func listWorkspaceRegulationsWithRequestBuilder(pagination: PaginationInput, status: Status_listWorkspaceRegulations? = nil, regulationTypes: [RegulationTypes_listWorkspaceRegulations]? = nil) -> RequestBuilder<ListWorkspaceRegulations200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListWorkspaceRegulations200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
