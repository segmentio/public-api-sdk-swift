...
open class EdgeFunctionsAPI {
     ...
     */
    @discardableResult
    open class func createEdgeFunctions(sourceId: String, createEdgeFunctionsAlphaInput: CreateEdgeFunctionsAlphaInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CreateEdgeFunctions200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createEdgeFunctionsWithRequestBuilder(sourceId: String, createEdgeFunctionsAlphaInput: CreateEdgeFunctionsAlphaInput) -> RequestBuilder<CreateEdgeFunctions200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CreateEdgeFunctions200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func disableEdgeFunctions(sourceId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DisableEdgeFunctions200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func disableEdgeFunctionsWithRequestBuilder(sourceId: String) -> RequestBuilder<DisableEdgeFunctions200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<DisableEdgeFunctions200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func generateUploadURLForEdgeFunctions(sourceId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GenerateUploadURLForEdgeFunctions200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func generateUploadURLForEdgeFunctionsWithRequestBuilder(sourceId: String) -> RequestBuilder<GenerateUploadURLForEdgeFunctions200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GenerateUploadURLForEdgeFunctions200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getLatestFromEdgeFunctions(sourceId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetLatestFromEdgeFunctions200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getLatestFromEdgeFunctionsWithRequestBuilder(sourceId: String) -> RequestBuilder<GetLatestFromEdgeFunctions200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetLatestFromEdgeFunctions200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
