...
open class SpacesAPI {
    ...
    open class func batchQueryMessagingSubscriptionsForSpaceWithRequestBuilder(spaceId: String, batchQueryMessagingSubscriptionsForSpaceAlphaInput: BatchQueryMessagingSubscriptionsForSpaceAlphaInput) -> RequestBuilder<BatchQueryMessagingSubscriptionsForSpace200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<BatchQueryMessagingSubscriptionsForSpace200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getSpace(spaceId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetSpace200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getSpaceWithRequestBuilder(spaceId: String) -> RequestBuilder<GetSpace200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetSpace200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func replaceMessagingSubscriptionsInSpacesWithRequestBuilder(spaceId: String, replaceMessagingSubscriptionsInSpacesAlphaInput: ReplaceMessagingSubscriptionsInSpacesAlphaInput) -> RequestBuilder<ReplaceMessagingSubscriptionsInSpaces200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ReplaceMessagingSubscriptionsInSpaces200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
