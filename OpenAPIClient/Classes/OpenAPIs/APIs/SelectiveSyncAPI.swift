...
open class SelectiveSyncAPI {
     ...
     */
    @discardableResult
    open class func getAdvancedSyncScheduleFromWarehouse(warehouseId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetAdvancedSyncScheduleFromWarehouse200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getAdvancedSyncScheduleFromWarehouseWithRequestBuilder(warehouseId: String) -> RequestBuilder<GetAdvancedSyncScheduleFromWarehouse200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetAdvancedSyncScheduleFromWarehouse200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listSelectiveSyncsFromWarehouseAndSource(warehouseId: String, sourceId: String, pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ListSelectiveSyncsFromWarehouseAndSource200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func listSelectiveSyncsFromWarehouseAndSourceWithRequestBuilder(warehouseId: String, sourceId: String, pagination: PaginationInput) -> RequestBuilder<ListSelectiveSyncsFromWarehouseAndSource200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListSelectiveSyncsFromWarehouseAndSource200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listSyncsFromWarehouse(warehouseId: String, pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ListSyncsFromWarehouse200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func listSyncsFromWarehouseWithRequestBuilder(warehouseId: String, pagination: PaginationInput) -> RequestBuilder<ListSyncsFromWarehouse200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListSyncsFromWarehouse200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listSyncsFromWarehouseAndSource(warehouseId: String, sourceId: String, pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ListSyncsFromWarehouseAndSource200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func listSyncsFromWarehouseAndSourceWithRequestBuilder(warehouseId: String, sourceId: String, pagination: PaginationInput) -> RequestBuilder<ListSyncsFromWarehouseAndSource200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListSyncsFromWarehouseAndSource200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func replaceAdvancedSyncScheduleForWarehouseWithRequestBuilder(warehouseId: String, replaceAdvancedSyncScheduleForWarehouseV1Input: ReplaceAdvancedSyncScheduleForWarehouseV1Input) -> RequestBuilder<ReplaceAdvancedSyncScheduleForWarehouse200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ReplaceAdvancedSyncScheduleForWarehouse200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func updateSelectiveSyncForWarehouseWithRequestBuilder(warehouseId: String, updateSelectiveSyncForWarehouseV1Input: UpdateSelectiveSyncForWarehouseV1Input) -> RequestBuilder<UpdateSelectiveSyncForWarehouse200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<UpdateSelectiveSyncForWarehouse200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
