...
open class CatalogAPI {
     ...
     */
    @discardableResult
    open class func getDestinationMetadata(destinationMetadataId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetDestinationMetadata200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getDestinationMetadataWithRequestBuilder(destinationMetadataId: String) -> RequestBuilder<GetDestinationMetadata200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetDestinationMetadata200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDestinationsCatalog(pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetDestinationsCatalog200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getDestinationsCatalogWithRequestBuilder(pagination: PaginationInput) -> RequestBuilder<GetDestinationsCatalog200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetDestinationsCatalog200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getSourceMetadata(sourceMetadataId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetSourceMetadata200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getSourceMetadataWithRequestBuilder(sourceMetadataId: String) -> RequestBuilder<GetSourceMetadata200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetSourceMetadata200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getSourcesCatalog(pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetSourcesCatalog200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getSourcesCatalogWithRequestBuilder(pagination: PaginationInput) -> RequestBuilder<GetSourcesCatalog200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetSourcesCatalog200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getWarehouseMetadata(warehouseMetadataId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetWarehouseMetadata200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getWarehouseMetadataWithRequestBuilder(warehouseMetadataId: String) -> RequestBuilder<GetWarehouseMetadata200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetWarehouseMetadata200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getWarehousesCatalog(pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetWarehousesCatalog200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getWarehousesCatalogWithRequestBuilder(pagination: PaginationInput) -> RequestBuilder<GetWarehousesCatalog200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetWarehousesCatalog200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
