...
open class DestinationFiltersAPI {
     ...
     */
    @discardableResult
    open class func createFilterForDestination(destinationId: String, createFilterForDestinationV1Input: CreateFilterForDestinationV1Input, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CreateFilterForDestination200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createFilterForDestinationWithRequestBuilder(destinationId: String, createFilterForDestinationV1Input: CreateFilterForDestinationV1Input) -> RequestBuilder<CreateFilterForDestination200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CreateFilterForDestination200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getFilterInDestination(destinationId: String, filterId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetFilterInDestination200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getFilterInDestinationWithRequestBuilder(destinationId: String, filterId: String) -> RequestBuilder<GetFilterInDestination200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetFilterInDestination200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listFiltersFromDestination(destinationId: String, pagination: PaginationInput, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ListFiltersFromDestination200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func listFiltersFromDestinationWithRequestBuilder(destinationId: String, pagination: PaginationInput) -> RequestBuilder<ListFiltersFromDestination200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ListFiltersFromDestination200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func previewDestinationFilter(previewDestinationFilterV1Input: PreviewDestinationFilterV1Input, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: PreviewDestinationFilter200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func previewDestinationFilterWithRequestBuilder(previewDestinationFilterV1Input: PreviewDestinationFilterV1Input) -> RequestBuilder<PreviewDestinationFilter200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PreviewDestinationFilter200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func removeFilterFromDestination(destinationId: String, filterId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: RemoveFilterFromDestination200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func removeFilterFromDestinationWithRequestBuilder(destinationId: String, filterId: String) -> RequestBuilder<RemoveFilterFromDestination200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<RemoveFilterFromDestination200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func updateFilterForDestinationWithRequestBuilder(destinationId: String, filterId: String, updateFilterForDestinationV1Input: UpdateFilterForDestinationV1Input) -> RequestBuilder<UpdateFilterForDestination200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<UpdateFilterForDestination200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
