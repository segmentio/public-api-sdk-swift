...
open class DeliveryOverviewAPI {
     ...
     */
    @discardableResult
    open class func getLinkedAudienceSuccessMetricsFromDeliveryOverview(apiResponseQueue: DispatchQueue = PublicApiAPI.apiResponseQueue, completion: @escaping ((_ data: GetEgressFailedMetricsFromDeliveryOverview200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return getLinkedAudienceSuccessMetricsFromDeliveryOverviewWithRequestBuilder().execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<GetEgressFailedMetricsFromDeliveryOverview200Response> 
     */
    open class func getLinkedAudienceSuccessMetricsFromDeliveryOverviewWithRequestBuilder() -> RequestBuilder<GetEgressFailedMetricsFromDeliveryOverview200Response> {
