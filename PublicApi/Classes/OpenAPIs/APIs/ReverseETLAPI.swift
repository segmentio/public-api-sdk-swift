...
open class ReverseETLAPI {
     ...
     */
    @discardableResult
    open class func getReverseETLSyncStatusesBySubscriptionId(modelId: String, subscriptionId: String, pagination: PaginationInput? = nil, apiResponseQueue: DispatchQueue = PublicApiAPI.apiResponseQueue, completion: @escaping ((_ data: GetReverseETLSyncStatusesBySubscriptionId200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return getReverseETLSyncStatusesBySubscriptionIdWithRequestBuilder(modelId: modelId, subscriptionId: subscriptionId, pagination: pagination).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter subscriptionId: (path)  
     - parameter pagination: (query) Optional pagination params.  This parameter exists in alpha. (optional)
     - returns: RequestBuilder<GetReverseETLSyncStatusesBySubscriptionId200Response> 
     */
    open class func getReverseETLSyncStatusesBySubscriptionIdWithRequestBuilder(modelId: String, subscriptionId: String, pagination: PaginationInput? = nil) -> RequestBuilder<GetReverseETLSyncStatusesBySubscriptionId200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetReverseETLSyncStatusesBySubscriptionId200Response>.Type = PublicApiAPI.requestBuilderFactory.getBuilder()
