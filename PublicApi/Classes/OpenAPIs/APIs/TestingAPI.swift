...
open class TestingAPI {
     ...
     */
    @discardableResult
    open class func echo(message: String, delay: Double? = nil, triggerError: Bool? = nil, triggerMultipleErrors: Bool? = nil, triggerUnexpectedError: Bool? = nil, statusCode: Double? = nil, apiResponseQueue: DispatchQueue = PublicApiAPI.apiResponseQueue, completion: @escaping ((_ data: Echo200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func echoWithRequestBuilder(message: String, delay: Double? = nil, triggerError: Bool? = nil, triggerMultipleErrors: Bool? = nil, triggerUnexpectedError: Bool? = nil, statusCode: Double? = nil) -> RequestBuilder<Echo200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Echo200Response>.Type = PublicApiAPI.requestBuilderFactory.getBuilder()
