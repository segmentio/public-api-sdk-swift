...
public struct BatchQueryMessagingSubscriptionsForSpaceAlphaOutput: Codable, JSONEncodable, Hashable {
    ...
    public init(successes: [GetMessagingSubscriptionSuccessResponse], failures: [GetMessagingSubscriptionFailureResponse], errors: [MessageSubscriptionResponseError], pagination: Pagination4? = nil) {
