...
public struct CreateAudienceBetaInput: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, enabled: Bool? = nil, description: String? = nil, computeConditionsWrapper: ComputeConditionsWrapper, productVariant: ProductVariant, options: Options2? = nil, targetEntity: String? = nil) {
        self.name = name
