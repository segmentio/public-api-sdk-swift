//
// GetDeliveryOverviewSourceMetricsBetaInput.swift
//
...
public struct GetDeliveryOverviewSourceMetricsBetaInput: Codable, JSONEncodable, Hashable {
    ...
    public init(sourceId: String, destinationConfigId: String? = nil, startTime: String, endTime: String, groupBy: [String]? = nil, granularity: Granularity, filter: Filter? = nil, pagination: Pagination1, subscriptionId: String? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(destinationConfigId, forKey: .destinationConfigId)
