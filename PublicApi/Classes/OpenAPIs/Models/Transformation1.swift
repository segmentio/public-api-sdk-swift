...
public struct Transformation1: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, name: String, sourceId: String, destinationMetadataId: String? = nil, enabled: Bool, _if: String, newEventName: String? = nil, propertyRenames: [PropertyRenameBeta]? = nil, propertyValueTransformations: [PropertyValueTransformationBeta]? = nil) {
        self.id = id
        self.name = name
