...
public struct AudiencePreviewAnyOf: Codable, JSONEncodable, Hashable {
    ...
    public init(status: Status, results: [AudiencePreviewResult], size: AudienceSize, id: String, audienceType: AudienceType, definition: AudienceDefinitionWithoutType, options: AudiencePreviewOptions) {
        self.status = status
