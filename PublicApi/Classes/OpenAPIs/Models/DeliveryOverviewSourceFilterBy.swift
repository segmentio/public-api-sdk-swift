//
// DeliveryOverviewSourceFilterBy.swift
//
...
public struct DeliveryOverviewSourceFilterBy: Codable, JSONEncodable, Hashable {
    ...
    public init(discardReason: [String]? = nil, eventName: [String]? = nil, eventType: [String]? = nil, appVersion: [String]? = nil, activationId: [String]? = nil, audienceId: [String]? = nil, spaceId: [String]? = nil) {
