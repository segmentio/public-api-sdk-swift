...
public struct ListAudiencesOutput: Codable, JSONEncodable, Hashable {
    ...
    public init(audiences: [AudienceSummaryWithAudienceTypeAndLookback], pagination: Pagination3) {
