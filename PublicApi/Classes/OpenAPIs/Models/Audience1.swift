...
public struct Audience1: Codable, JSONEncodable, Hashable {
    ...
    public init(audienceType: AudienceType, computeCadence: ComputeCadence, options: Options1? = nil, id: String, spaceId: String, name: String, description: String? = nil, key: String, enabled: Bool, definition: Definition4?, status: String? = nil, createdBy: String, updatedBy: String, createdAt: String, updatedAt: String) {
