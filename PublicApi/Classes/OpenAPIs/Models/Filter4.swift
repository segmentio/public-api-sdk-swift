...
public struct Filter4: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, workspaceId: String, integrationId: String, enabled: Bool? = nil, drop: Bool? = nil, name: String, description: String? = nil, _if: String, productArea: String? = nil, propertyDrops: [String]? = nil, allowProperties: [String]? = nil) {
        self.id = id
