...
public struct AudiencePreviewAnyOf2: Codable, JSONEncodable, Hashable {
    ...
    public init(status: Status, failureReason: String? = nil, id: String, audienceType: AudienceType, definition: AudienceDefinitionWithoutType, options: AudiencePreviewOptions) {
        self.status = status
