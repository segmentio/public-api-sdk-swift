...
public struct UpdateFilterByIdInput: Codable, JSONEncodable, Hashable {
    ...
    public init(integrationId: String, enabled: Bool? = nil, drop: Bool? = nil, name: String? = nil, description: String? = nil, _if: String? = nil, propertyDrops: [String]? = nil, allowProperties: [String]? = nil) {
