...
public struct ComputedTraitSummary: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, spaceId: String, name: String, description: String? = nil, key: String, enabled: Bool, definition: Definition4?, status: String? = nil, createdBy: String, updatedBy: String, createdAt: String, updatedAt: String, options: Options4? = nil) {
        self.id = id
