...
public struct CreateFilterInput: Codable, JSONEncodable, Hashable {
    ...
    public init(integrationId: String, enabled: Bool? = nil, drop: Bool? = nil, name: String, description: String? = nil, _if: String, propertyDrops: [String]? = nil, allowProperties: [String]? = nil) {
