...
public struct AudiencePreview1: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, audienceType: AudienceType, definition: Definition5, options: Options4, status: Status, results: [AudiencePreviewResult]? = nil, size: Size1? = nil, failureReason: String? = nil) {
        self.id = id
